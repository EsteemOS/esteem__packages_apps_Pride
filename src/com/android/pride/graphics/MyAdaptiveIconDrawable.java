 ...
 * </pre>
 */
public class MyAdaptiveIconDrawable extends AdaptiveIconDrawable implements Drawable.Callback {
    ...
    */
     ...
     */
    MyAdaptiveIconDrawable(LayerState state, Resources res) {
        super(null, null);
     ...
     */
    public MyAdaptiveIconDrawable(Drawable backgroundDrawable,
            Drawable foregroundDrawable, Context context) {
        this((LayerState)null, null);

        String iconShapePath = Utilities.getIconShapePath(context);
        mBaseMask = PathParser.createPathFromPathData(iconShapePath);
        mMask = mBaseMask;
    ...
    private void updateMaskBoundsInternal(Rect b) {
        ...
        mBaseMask.transform(mMaskMatrix, mMask);
    ...
    public void applyTheme(Theme t) {
        ...
        final int density = resolveDensity(t.getResources(), 0);
    ...
    static class ChildDrawable {
        ...
        ChildDrawable(ChildDrawable orig, MyAdaptiveIconDrawable owner,
                Resources res) {
            ...
            mDensity = MyAdaptiveIconDrawable.resolveDensity(res, orig.mDensity);
        }
    ...
    static class LayerState extends ConstantState {
        ...
        LayerState(LayerState orig, MyAdaptiveIconDrawable owner,
                Resources res) {
            mDensity = owner.resolveDensity(res, orig != null ? orig.mDensity : 0);
        ...
        public Drawable newDrawable() {
            return new MyAdaptiveIconDrawable(this, null);
        }

        @Override
        public Drawable newDrawable(Resources res) {
            return new MyAdaptiveIconDrawable(this, res);
        }
