...
*
*/
package com.android.Pride3.topwidget;
...
import com.android.Pride3.R;
import com.android.Pride3.Pride;
import com.android.Pride3.Utilities;
...
public class CalendarView extends FrameLayout implements CalendarClient.CalendarEventObserver {
    ...
    private static final String TAG = "Pride3:CalendarView";
    ...
    private class EventListAdapter extends ArrayAdapter<CalendarEventModel.EventInfo> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Pride Pride = Pride.getPride(getContext());
                    Intent intent = getEventIntent(event.id, 0, 0, false);
                    if (intent != null) {
                        Pride.startActivitySafely(null, intent, null);
                    }
                }
            });
            return convertView;
        ...
        @Override
        public int getCount() {
            return Math.min(mEventData.size(), SHOW_NUM_EVENTS);
        }
    }
    ...
    public void checkPermissions() {
        Pride Pride = Pride.getPride(getContext());
        boolean permsChecked = Pride.isCalendarPermissionEnabled();
    ...
    protected void onFinishInflate() {
        ...
        mCalendarStatusText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Pride Pride = Pride.getPride(getContext());
                if (!Pride.isCalendarPermissionEnabled()) {
                    Pride.requestCalendarPermission();
                } else {
