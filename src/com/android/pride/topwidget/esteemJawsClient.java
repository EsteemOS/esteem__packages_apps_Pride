/*
* Copyright (C) 2017 The esteemROM Project
*
...
public class esteemJawsClient {
    private static final String TAG = "Pride:esteemJawsClient";
    private static final boolean DEBUG = false;
    public static final String SERVICE_PACKAGE = "org.esteemrom.esteemjaws";
    public static final Uri WEATHER_URI
            = Uri.parse("content://org.esteemrom.esteemjaws.provider/weather");
    public static final Uri SETTINGS_URI
            = Uri.parse("content://org.esteemrom.esteemjaws.provider/settings");

    private static final String ICON_PACKAGE_DEFAULT = "org.esteemrom.esteemjaws";
    ...
    private static final String WEATHER_UPDATE = "org.esteemrom.esteemjaws.WEATHER_UPDATE";
    private static final String WEATHER_ERROR = "org.esteemrom.esteemjaws.WEATHER_ERROR";
    ...
    public static interface esteemJawsObserver {
    ...
    private class WeatherUpdateReceiver extends BroadcastReceiver {
        ...
        public void onReceive(final Context context, Intent intent) {
            ...
            for (esteemJawsObserver observer : mObserver) {
    ...
    private List<esteemJawsObserver> mObserver;
    private WeatherUpdateReceiver mReceiver;

    public esteemJawsClient(Context context) {
        mContext = context;
        mObserver = new ArrayList<esteemJawsObserver>();
    ...
    public void updateWeather() {
        if (isesteemJawsServiceInstalled()) {
    ...
    public Intent getSettingsIntent() {
        if (isesteemJawsServiceInstalled()) {
            Intent settings = new Intent(Intent.ACTION_MAIN)
                    .setClassName("org.esteemrom.esteemjaws", "org.esteemrom.esteemjaws.SettingsActivityService");
            return settings;
        }
        return null;
    }
    ...
    public void loadCustomIconPackage() {
        String settingPackage = Utilities.getWeatherIconPack(mContext);
        if (settingPackage != null) {
            mSettingIconPackage = settingPackage;
    ...
    public boolean isesteemJawsServiceInstalled() {
        return isAvailableApp(SERVICE_PACKAGE);
    }

    public boolean isesteemJawsEnabled() {
        if (!isesteemJawsServiceInstalled()) {
            return false;
        }
    ...
    public void setesteemJawsEnabled(boolean value) {
        if (isesteemJawsServiceInstalled()) {
    ...
    public boolean isesteemJawsSetupDone() {
        if (!isesteemJawsServiceInstalled()) {
            return false;
        }
        final Cursor c = mContext.getContentResolver().query(SETTINGS_URI, SETTINGS_PROJECTION,
    ...
    public void addObserver(esteemJawsObserver observer) {
        if (mObserver.size() == 0) {
            if (mReceiver != null) {
                try {
                    mContext.unregisterReceiver(mReceiver);
    ...
    public void removeObserver(esteemJawsObserver observer) {
