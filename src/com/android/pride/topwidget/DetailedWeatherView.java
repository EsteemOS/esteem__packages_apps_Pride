...
public class DetailedWeatherView extends FrameLayout {
    ...
    public void updateWeatherData(esteemJawsClient weatherClient, esteemJawsClient.WeatherInfo weatherData) {
        ...
        if (mShowCurrent) {
            ...
            mCurrentText.setText(mContext.getResources().getText(R.string.esteemjaws_current_text));
        }
    }
