...
import com.android.Pride.AutoInstallsLayout.LayoutParserCallback;
...
import com.android.Pride.util.NoLocaleSqliteContext;
...
public class LauncherProvider extends ContentProvider {
    ...
    /**
     * $ adb shell dumpsys activity provider com.android.Pride
     */
    @Override
    ...
    public static class DatabaseHelper extends SQLiteOpenHelper implements LayoutParserCallback {
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            ...
            switch (oldVersion) {
                // The version cannot be lower that 12, as Pride never supported a lower
                // version of the DB.
                case 12: {
